...
const products = [
  ...
  { id: 'd3', categoryId: 'dairy', name: 'Desi Cow Ghee', weight: '500 ml', price: 450, image: 'https://images.unsplash.com/photo-1587049352847-4d4b1273661b' },
  { id: 'd4', categoryId: 'dairy', name: 'Amul Butter', weight: '100 gm', price: 60, image: 'https://images.unsplash.com/photo-1589985270826-4b7bb135bc9d' },
  { id: 'd5', categoryId: 'dairy', name: 'Fresh Curd (Dahi)', weight: '400 gm', price: 40, image: 'https://images.unsplash.com/photo-1628189679244-c68e82ef4518' },
...
export async function GET(request) {
  ...
  filtered = filtered.map(p => {
    if (p.image.includes('unsplash.com') && !p.image.includes('?')) {
      return { ...p, image: p.image + '?auto=format&fit=crop&w=400&q=80' };
    }
    return p;
  });
